...
var filter_ServiceMonitoringService_CreateService_0 = &utilities.DoubleArray{Encoding: map[string]int{"service": 0, "parent": 1}, Base: []int{1, 1, 2, 0, 0}, Check: []int{0, 1, 1, 2, 3}}
...
var filter_ServiceMonitoringService_ListServices_0 = &utilities.DoubleArray{Encoding: map[string]int{"parent": 0}, Base: []int{1, 1, 0}, Check: []int{0, 1, 2}}
...
var filter_ServiceMonitoringService_UpdateService_0 = &utilities.DoubleArray{Encoding: map[string]int{"service": 0, "name": 1}, Base: []int{1, 2, 1, 0, 0}, Check: []int{0, 1, 2, 3, 2}}
...
var filter_ServiceMonitoringService_CreateServiceLevelObjective_0 = &utilities.DoubleArray{Encoding: map[string]int{"service_level_objective": 0, "parent": 1}, Base: []int{1, 1, 2, 0, 0}, Check: []int{0, 1, 1, 2, 3}}
...
func request_ServiceMonitoringService_CreateServiceLevelObjective_0(ctx context.Context, marshaler runtime.Marshaler, client ServiceMonitoringServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var (
		protoReq CreateServiceLevelObjectiveRequest
		metadata runtime.ServerMetadata
		err      error
	)
	if err := marshaler.NewDecoder(req.Body).Decode(&protoReq.ServiceLevelObjective); err != nil && !errors.Is(err, io.EOF) {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}
	if req.Body != nil {
		_, _ = io.Copy(io.Discard, req.Body)
...
var filter_ServiceMonitoringService_GetServiceLevelObjective_0 = &utilities.DoubleArray{Encoding: map[string]int{"name": 0}, Base: []int{1, 1, 0}, Check: []int{0, 1, 2}}
...
func request_ServiceMonitoringService_GetServiceLevelObjective_0(ctx context.Context, marshaler runtime.Marshaler, client ServiceMonitoringServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var (
		protoReq GetServiceLevelObjectiveRequest
		metadata runtime.ServerMetadata
		err      error
	)
	if req.Body != nil {
...
var filter_ServiceMonitoringService_ListServiceLevelObjectives_0 = &utilities.DoubleArray{Encoding: map[string]int{"parent": 0}, Base: []int{1, 1, 0}, Check: []int{0, 1, 2}}
...
func request_ServiceMonitoringService_ListServiceLevelObjectives_0(ctx context.Context, marshaler runtime.Marshaler, client ServiceMonitoringServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var (
		protoReq ListServiceLevelObjectivesRequest
		metadata runtime.ServerMetadata
		err      error
	)
	if req.Body != nil {
...
var filter_ServiceMonitoringService_UpdateServiceLevelObjective_0 = &utilities.DoubleArray{Encoding: map[string]int{"service_level_objective": 0, "name": 1}, Base: []int{1, 2, 1, 0, 0}, Check: []int{0, 1, 2, 3, 2}}
...
func request_ServiceMonitoringService_UpdateServiceLevelObjective_0(ctx context.Context, marshaler runtime.Marshaler, client ServiceMonitoringServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var (
		protoReq UpdateServiceLevelObjectiveRequest
		metadata runtime.ServerMetadata
		err      error
	)
	newReader, berr := utilities.IOReaderFactory(req.Body)
	...
	if err := marshaler.NewDecoder(newReader()).Decode(&protoReq.ServiceLevelObjective); err != nil && !errors.Is(err, io.EOF) {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}
	if req.Body != nil {
		_, _ = io.Copy(io.Discard, req.Body)
...
func request_ServiceMonitoringService_DeleteServiceLevelObjective_0(ctx context.Context, marshaler runtime.Marshaler, client ServiceMonitoringServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var (
		protoReq DeleteServiceLevelObjectiveRequest
		metadata runtime.ServerMetadata
		err      error
	)
	if req.Body != nil {
...
func RegisterServiceMonitoringServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server ServiceMonitoringServiceServer) error {
	mux.Handle(http.MethodPost, pattern_ServiceMonitoringService_CreateService_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
	...
	mux.Handle(http.MethodGet, pattern_ServiceMonitoringService_GetService_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
	...
	mux.Handle(http.MethodGet, pattern_ServiceMonitoringService_ListServices_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
	...
	mux.Handle(http.MethodPatch, pattern_ServiceMonitoringService_UpdateService_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
	...
	mux.Handle(http.MethodDelete, pattern_ServiceMonitoringService_DeleteService_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
	...
	mux.Handle(http.MethodPost, pattern_ServiceMonitoringService_CreateServiceLevelObjective_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
	...
	mux.Handle(http.MethodGet, pattern_ServiceMonitoringService_GetServiceLevelObjective_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
	...
	mux.Handle(http.MethodGet, pattern_ServiceMonitoringService_ListServiceLevelObjectives_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
	...
	mux.Handle(http.MethodPatch, pattern_ServiceMonitoringService_UpdateServiceLevelObjective_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
	...
	mux.Handle(http.MethodDelete, pattern_ServiceMonitoringService_DeleteServiceLevelObjective_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
...
// "ServiceMonitoringServiceClient" to call the correct interceptors. This client ignores the HTTP middlewares.
